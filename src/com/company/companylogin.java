...
public class companylogin extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b1){
            try{
                ...
                String q = "select * from company where name='"+u+"' and password='"+v+"'";

                ResultSet rs = c1.s.executeQuery(q);
                if(rs.next()){
                    new companydashboard(u).setVisible(true);
